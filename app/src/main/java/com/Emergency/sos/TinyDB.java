...
public class TinyDB {
    ...
    public ArrayList<Contact> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();
    ...
    public void putListObject(String key, ArrayList<Contact> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
